...
confirm_submission.boxTwoDescription = TAW sy’n ddyledus yn y cyfnod ar gaffael nwyddau a wneir yng Ngogledd Iwerddon o Aelod-wladwriaethau’r UE
confirm_submission.boxTwoAmt = Swm Blwch 2
confirm_submission.boxThree = Blwch 3
confirm_submission.boxThreeDescription = Cyfanswm y TAW sy’n ddyledus (dyma gyfanswm blychau 1 a 2)
...
confirm_submission.boxSevenDescription = Cyfanswm gwerth y pryniadau a’r holl fewnbynnau eraill, heb gynnwys TAW
confirm_submission.boxSevenAmt = Swm Blwch 7
confirm_submission.boxEight = Blwch 8
confirm_submission.boxEightDescription = Cyfanswm gwerth anfon y nwyddau a’r costau cysylltiedig (ac eithrio TAW) o Ogledd Iwerddon i Aelod-wladwriaethau’r UE
confirm_submission.boxEightAmt = Swm Blwch 8
confirm_submission.boxNine = Blwch 9
confirm_submission.boxNineDescription = Cyfanswm gwerth caffael y nwyddau a’r costau cysylltiedig (ac eithrio TAW) a wneir yng Ngogledd Iwerddon o Aelod-wladwriaethau’r UE
...
signUpForMTDBanner.heading = Newidiodd y ffordd yr ydych yn cyflwyno eich Ffurflenni TAW ar 1 Ebrill oherwydd y cynllun Troi Treth yn Ddigidol
signUpForMTDBanner.paragraphText = Ni allwch ddefnyddio’r gwasanaeth hwn i gyflwyno Ffurflenni TAW ar gyfer cyfnodau cyfrifyddu sy’n dechrau ar ôl 1 Ebrill 2022. Yn lle hynny, bydd angen i chi gadw cofnodion digidol a chyflwyno Ffurflenni TAW gan ddefnyddio meddalwedd sy’n cydweddu â CThEM.
signUpForMTDBanner.linkText = Dysgwch pryd y mae angen i chi gofrestru a dechrau defnyddio Troi Treth yn Ddigidol ar gyfer TAW (yn agor tab newydd)
