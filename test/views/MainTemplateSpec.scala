  ...
  "MainTemplate" when {
    ...
    "the user is an Agent" should {
      ...
      "have the correct service name" in {
        elementText(".govuk-header__link--service-name") shouldBe "Your client’s VAT details"
      }

      "have the correct service URL" in {
        element(".govuk-header__link--service-name").attr("href") shouldBe mockAppConfig.manageClientUrl
      }
    }
    ...
    "the user is not an Agent" should {
      ...
      "have the correct service URL" in {
        element(".govuk-header__link--service-name").attr("href") shouldBe mockAppConfig.btaHomeUrl
      }
    }
    ...
    "the user type cannot be determined" should {
      ...
      "have the correct service name" in {
        elementText(".govuk-header__link--service-name") shouldBe "VAT"
      }
